#!/usr/bin/env python3
"""Validate Lesson 06 scaling artifacts."""
...
def main():
    ...
    print(f"baseline_world_size={summaries['scaling-1gcd']['world_size']}")
    print(f"single_node_world_size={summaries['scaling-8gcd-single-node']['world_size']}")
    print(f"multi_node_world_size={summaries['scaling-multi-node']['world_size']}")
    print(f"baseline_gpu_visible_count={summaries['scaling-1gcd']['gpu_visible_count']}")
