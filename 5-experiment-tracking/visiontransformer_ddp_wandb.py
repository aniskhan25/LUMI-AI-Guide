...
if rank == 0:
    wandb.init(
        ...
        name=os.getenv("SLURM_JOB_ID", "local"),
        config={"learning_rate": 0.001, "architecture": "vit_b_16", "epochs": 10},
    )
...
def train_model(model, criterion, optimizer, train_loader, val_loader, epochs=10):
    ...
    for epoch in range(epochs):
        ...
        if rank == 0:
            ...
            wandb.log({"loss": running_loss / len(train_loader), "acc": 100 * correct / total})
